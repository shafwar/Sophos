...
<body>
    ...
    <div class="container-fluid px-4 py-3 mt-4" style="background: white; border-bottom: 1px solid #e5e7eb;">
        ...
        <div class="alert alert-primary" role="alert">
            ...
            <p>Ini adalah dashboard khusus admin. Anda dapat melihat data monitoring antivirus dan mengakses fitur admin lainnya.</p>
        </div>
    </div>

    <!-- Mulai konten utama dashboard.blade.php -->
    <div class="container mt-5">
        <!-- Summary Metrics -->
        <div class="row mb-4">
